...
async function loadFacts() {
  const res = await fetch(
    "https://suxsfvcqoqyneuxxkftp.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN1eHNmdmNxb3F5bmV1eHhrZnRwIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTAyODQwMjAsImV4cCI6MjAwNTg2MDAyMH0.IV8Kgy3X3YxxbtN_gqgMBGIUuMDDjlM4JB8p7jcHiMM",
      },
    }
  );
